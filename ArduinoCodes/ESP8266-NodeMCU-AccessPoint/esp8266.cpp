// this version is ment for ESP8266-NodeMCU boards not ESP32 Boards
...
// // Ticker serialChecker;
// // Ticker clientHandler;
...
//   // serialChecker.attach(0.1, checkSerial);  // Check serial every 100ms
//   // clientHandler.attach(0.05, handleClientRequests);  // Handle clients every 50ms
// }
...
// void loop() {
//   // The main loop is now empty, as tasks are handled by Ticker callbacks
